...
void drawEps()
{
    ...
    TFile* uuFile = new TFile("193GeVData/UU193Eps.root","READ");
    TFile* auauFile = new TFile("200GeVData/AuAu200Eps.root","READ");
    ...
    epsFCanvas->cd(1);
    tmg[0][0][1]->Draw("alp");
    tmg[0][0][1]->SetTitle("0.5-1% Zdc -- q2");

    epsFCanvas->cd(2);
    tmg[0][1][1]->Draw("alp");
    tmg[0][1][1]->SetTitle("0.5-1% Zdc -- mult");

    epsFCanvas->cd(3);
    tmg[0][0][0]->Draw("alp");
    tmg[0][0][0]->SetTitle("0-0.5% Zdc -- q2");

    epsFCanvas->cd(4);
    tmg[0][1][0]->Draw("alp");
    tmg[0][1][0]->SetTitle("0-0.5% Zdc -- mult");
    ...
    RlCanvas->cd(1);
    tmg[1][0][1]->Draw("alp");
    tmg[1][0][1]->SetTitle("0.5-1% Zdc -- q2");

    RlCanvas->cd(2);
    tmg[1][1][1]->Draw("alp");
    tmg[1][1][1]->SetTitle("0.5-1% Zdc -- mult");

    RlCanvas->cd(3);
    tmg[1][0][0]->Draw("alp");
    tmg[1][0][0]->SetTitle("0-0.5% Zdc -- q2");

    RlCanvas->cd(4);
    tmg[1][1][0]->Draw("alp");
    tmg[1][1][0]->SetTitle("0-0.5% Zdc -- mult");
